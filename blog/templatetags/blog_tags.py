...
def truncatechars_content(content):
    """
    Obtain a summary of the content of the article
    :param content:
    :return:
    """
    from django.template.defaultfilters import truncatechars_html
    from Medgloss.utils import get_blog_setting
...
def load_sidebar(user, linktype):
    ...
    # Standard cloud computing word small
    # Calculate the average size (number / average) * step size according to the total number
    increment = 5
...
def load_pagination_info(page_obj, page_type, tag_name):
    ...
    if page_type == 'Category label archive':
    ...
    if page_type == 'Classification directory archive':
...
def load_article_detail(article, isindex, user):
    ...
    :param article:
    :param isindex:Whether a list page, if the list page shows a summary
    :return:
    """
    from Medgloss.utils import get_blog_setting
    blogsetting = get_blog_setting()
...
def gravatar_url(email, size=40):
    ...
    if cache.get(cachekey):
        ...
        default = "https://resource.medgloss.com/image/2017/03/26/120117.jpg".encode(
            'utf-8')
