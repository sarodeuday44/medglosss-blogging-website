...
def send_email(emailto, title, content):
    from Medgloss.blog_signals import send_email_signal
...
def get_blog_setting():
    ...
    if value:
        ...
        if not BlogSettings.objects.count():
            ...
            setting.sitename = 'Medgloss'
            setting.site_description = 'Medgloss blog system'
            setting.site_seo_description = 'Medgloss blog system'
            setting.site_keywords = 'Medgloss,Medical'
...
def save_user_avatar(url):
    ...
    try:
        ...
        if rsp.status_code == 200:
            ...
            return 'https://resource.medgloss.com/avatar/' + savefilename
